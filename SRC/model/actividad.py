from SRC.model.errores_actividad import ErrorFechaHoraInvalida, ErrorNoFechas, ErrorFechaInvalida, ErrorDescripcion, \
    ErrorFechaHora, ErrorNoAnexos, ErrorSesionNoIniciada
...
class Actividad:
    ...
    def __init__(self, idactividad: int, fechahora: datetime, responsable: str, descripcion: str,
                 condicionesclimaticas: str, anexos: list[Archivo], supervisor: Supervisor):
    ...
    def consultar_actividad(self):
        ...
        actividades_filtradas = [act for act in actividades if
                                 fecha_inicio <= datetime.datetime.strptime(act['fecha_hora'],
                                                                            "%Y-%m-%d %H:%M") <= fecha_fin]
        ...
        for act in actividades_filtradas:
            print(
                f"Fecha: {act['fecha_hora']}, Responsable: {act['responsable']}, Descripción: {act['descripcion']}, Clima: {act['condiciones_climaticas']}")
